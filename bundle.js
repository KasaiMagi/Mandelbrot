...
/***/ function(module, exports, __webpack_require__) {
	...
	var _javascriptRenderer = __webpack_require__(1);

	var _javascriptRenderer2 = _interopRequireDefault(_javascriptRenderer);

	setTimeout(function () {
	  _javascriptRenderer2['default'].init();
	  _javascriptRenderer2['default'].render();
	}, 200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _javascriptConfig = __webpack_require__(2);

	var _javascriptConfig2 = _interopRequireDefault(_javascriptConfig);

	var _javascriptMandelbrot = __webpack_require__(63);

	var _javascriptMandelbrot2 = _interopRequireDefault(_javascriptMandelbrot);

	var _javascriptTools = __webpack_require__(27);

	var _javascriptTools2 = _interopRequireDefault(_javascriptTools);

	var _javascriptViewport = __webpack_require__(64);

	var _javascriptViewport2 = _interopRequireDefault(_javascriptViewport);
	...
	exports['default'] = {
	  ...
	  render: function render(locationHash) {
	    if (!locationHash) {
	      locationHash = _javascriptTools2['default'].parseLocationHash(locationHash);
	    }

	    var self = this;

	    CONFIG = _javascriptConfig2['default'].getConfig(locationHash);

	    self.viewport = (0, _javascriptViewport2['default'])({
	      bounds: {
	    ...
	    _javascriptConfig2['default'].activelyRendering = true;
	    console.time('render timer');

	    new Promise(function (resolve) {
	      self.renderRows(dx, dy, topLeft, lastUpdate, imageData, 0, resolve);
	    }).then(function () {
	      _javascriptConfig2['default'].activelyRendering = false;
	      console.timeEnd('render timer');
	    });
	  },
	  renderRows: function renderRows(dx, dy, topLeft, lastUpdate, imageData, y_index, resolve) {
	  ...
	  renderRow: function renderRow(dx, dy, topLeft, lastUpdate, imageData, y_index) {
	    ...
	    for (var x_index = 0; x_index < this.canvas.width; x_index++) {
	      ...
	      for (var sample = 0; sample < SUPER_SAMPLES; sample++) {
	        ...
	        crossoverIteration += (0, _javascriptMandelbrot2['default'])({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  getConfig: function getConfig(locationHash) {
	    var config = locationHash || _javascriptTools2['default'].parseLocationHash();

	    return (0, _lodashObjectAssign2['default'])(DEFAULT_CONFIG, config);
	  }
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  parseLocationHash: function parseLocationHash(query) {
	  ...
	  setLocationHash: function setLocationHash(query) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var max_iterations = _javascriptConfig2['default'].getConfig().iterations;
	var Mandelbrot = function Mandelbrot(_x, _x2) {
	  var _again = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VIEWPORT_PROTOTYPE = {
	  ...
	  locationHash: function locationHash() {
	    var query = _javascriptTools2['default'].parseLocationHash();

	    return (0, _lodashObjectAssign2['default'])({}, query, {
	  ...
	  zoomToLocation: function zoomToLocation(location) {
	    ...
	    this.setBounds({
	      ...
	      _javascriptTools2['default'].setLocationHash(locationHash);
	      self.renderer.render(locationHash);
	    });
	  },
	  bindToCanvas: function bindToCanvas(canvas, renderer) {
	    var self = this;

	    self.renderer = renderer;
	    self.canvas = canvas;
	    self.canvas.addEventListener('click', function (event) {
	      if (!_javascriptConfig2['default'].activelyRendering) {
